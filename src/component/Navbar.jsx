...
export default function Navbar({}){
    ...
    return (
        <menu className="fixed top-[10px] w-4/5 px-5 py-2 bg-stone-500/50 z-20 flex justify-between items-center rounded-md border-solid border-white border">
            ...
            <li>
                <button className=" bg-[#28E5FF] px-5 py-2 uppercase font-bold text-stone-800 hover:text-stone-100 transition-all rounded-md border hover:bg-[#61beca] active:bg-[#317c88]">Donate</button>
            </li>
        </menu>
    )
}